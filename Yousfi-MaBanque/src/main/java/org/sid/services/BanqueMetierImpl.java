...
public class BanqueMetierImpl implements IBanqueMetier{
	...
	public void retirer(String codeCompte, double montant) {
		Compte cp = consulterCompte(codeCompte);
		double facilitiesCaisse=0;	//decouvert du compte
	...
	@Override
	public void viremente(String codeCompte, String codeCompte2, double montant) {
		if(codeCompte.equals(codeCompte2)) {
